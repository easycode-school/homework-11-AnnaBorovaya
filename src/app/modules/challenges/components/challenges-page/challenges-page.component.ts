...
export class ChallengesPageComponent implements OnInit {
  private challengeItems: ImagesChallenges[];
  private messageChallenge = false;
  private visibleUpcomingOverlay = false;
  private visibleOpenOverlay = true;
  private visibleClosedOverlay = false;
  constructor(
